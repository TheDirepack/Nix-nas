...
## Baseline 0.1 — 2026-08-25

- Reset versioning from the `2.2.0-alpha.x` line to `0.1` as a clean baseline. Full alpha history remains in `git log` and archived `CHANGELOG.md` entries prior to this reset.
