...
# The controller imports the operation journal/lock in the real repository. The
# focused adapter tests do not exercise those paths, so provide import-only
# stand-ins without changing adapter behavior.
class _Journal:
    @classmethod
